...
\title{Project Itterem}

\author{Glonczi Tamás\\Kulcsár Dénes\\Szoftverfejlesztő és -tesztelő szak}
\institute{Informatika és távközlés ágazat}
\supervisor{Horváth István\\oktató}
\city{Miskolc}
\date{2026}
\begin{figure}[h]
    \centering
...
A projekt célja egy modern, átfogó és felhasználóbarát online rendeléskezelő webalkalmazás kifejlesztése éttermek számára. A rendszer a teljes értékesítési folyamatot digitalizálja és optimalizálja a vásárlói rendelés leadásától kezdve, a konyhai feldolgozáson át, egészen az étel átvételéig.
...
\begin{itemize}
	...
	\item \textbf{Backend:} RESTful API ASP.NET Core 
	\item \textbf{Webes kliens:} Vue.js/Tailwind (Reszponzív kialakítás)
...
Az ADO.NET Entitás-keretrendszer (EF, Entity Framework) egy objektum-relációs leképező keretrendszer a .NET keretrendszerhez.{\cite{Entity}}
...
\bibitem{Varteresz} \textsc{Várterész Magdolna}: \emph{Az informatika logika alapjai előadások}, 2006/07-es tanév 1.félév, \url{http://users.atw.hu/de-mi/index.php?r=file/download\&id=219}, 
\bibitem{Entity} \textsc{Entity framework core}: \url{https://hu.wikipedia.org/wiki/Entity_Framework},

Letöltve: 2026 Február 23.-án
\end{thebibliography}
